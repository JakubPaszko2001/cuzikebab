  ...
  return (
    <section id="kontakt" className="relative flex h-screen w-full items-center justify-between overflow-hidden border-t-6 border-black bg-[#000000] py-[3vh] text-white md:h-auto md:min-h-screen md:px-[5vw] md:py-[5vh]">
      ...
      />
        ...
        {/* Tytuł KONTAKT */}
                <h2
          className="font-[FontMain] uppercase tracking-[2px] text-[#FFD300] text-7xl sm:text-9xl md:text-[12vw] leading-[0.85] mb-[2vh] md:mb-[4vh]"
                    style={{
        ...
        {/* Układ dwukolumnowy */}
        <div className="mb-[2vh] mt-[2vh] grid grid-cols-1 gap-[1.5vh] sm:grid-cols-2 sm:gap-[2.5vh_2vw] md:mb-[4vh] md:mt-[4vh]">
          {/* Telefon */}

          <div className="flex h-full min-h-0 items-start gap-4 md:min-h-[8vh] md:gap-[1vw]">
            <div className="shrink-0" style={{ filter: "drop-shadow(6px 8px 0px #000000)" }}>
                ...
                <span className="skew-x-[15deg] translate-x-[5.5px] md:translate-x-[8px]">
            ...
            <div>
              <h4 className="font-[FontMain] text-[#FFD300] uppercase text-xl leading-none tracking-wide md:text-[1.8vw] [text-shadow:2px_2px_0_#000000]">ZADZWON:</h4>
              <a href="tel:+48796664366" className="block text-sm font-bold leading-[1.2] text-white no-underline [text-shadow:1px_1px_2px_#000000] md:text-[1.1vw]">+48 796 664 366</a>
            </div>
          </div>
          ...
          <div className="flex h-full min-h-0 items-start gap-4 md:min-h-[8vh] md:gap-[1vw]">
            ...
            <div>
              <h4 className="font-[FontMain] text-[#FFD300] uppercase text-xl leading-none tracking-wide md:text-[1.8vw] [text-shadow:2px_2px_0_#000000]">NAPISZ DO NAS:</h4>
              <a href="mailto:Kontakt@cuzikebab.pl" className="block text-sm font-bold leading-[1.2] text-white no-underline [text-shadow:1px_1px_2px_#000000] md:text-[1.1vw]">Kontakt@cuzikebab.pl</a>
            </div>
          </div>
          ...
          <div className="flex h-full min-h-0 items-start gap-4 md:min-h-[8vh] md:gap-[1vw]">
            ...
            <div>
              <h4 className="font-[FontMain] text-[#FFD300] uppercase text-xl leading-none tracking-wide md:text-[1.8vw] [text-shadow:2px_2px_0_#000000]">ADRES:</h4>
              <p className="block text-sm font-bold leading-[1.2] text-white no-underline pt-[0.5vh] [text-shadow:1px_1px_2px_#000000] md:text-[1.1vw]">Aleje Jerozolimskie 87<br /><span className="mt-[0.5vh] block">02-001 Warszawa</span></p>
            </div>
          </div>
                ...
                <span className="skew-x-[15deg] translate-x-[5.5px] md:translate-x-[8px]">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="h-[70%] w-[70%] text-black">
                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/>
                            ...
                            <div>
                              <h4 className="font-[FontMain] text-[#FFD300] uppercase text-xl leading-none tracking-wide md:text-[1.8vw] [text-shadow:2px_2px_0_#000000]">OBSERWUJ NAS:</h4>
                              ...
                              <a href="https://www.tiktok.com/@cuzi.kebab?_r=1&_t=ZN-99Gqt2ZGXck" target="_blank" rel="noopener noreferrer" className="mt-[0.5vh] inline-flex items-center gap-[0.5vw] text-[14px] font-bold text-white no-underline md:text-[1vw]">
                                <svg viewBox="0 0 24 24" fill="currentColor" className="h-[1.2em] w-[1.2em] shrink-0 text-[#FFD300]">
          ...
          <div className="flex h-full min-h-0 items-start gap-4 md:min-h-[8vh] md:gap-[1vw]">
            <div className="shrink-0" style={{ filter: "drop-shadow(6px 8px 0px #000000)" }}>
                ...
                <span className="skew-x-[15deg] translate-x-[5.5px] md:translate-x-[8px]">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="h-[70%] w-[70%] text-black">
                    <path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm4.2 14.2L11 13V7h1.5v5.5L17.4 15z"/>
                  </svg>
                </span>
              </div>
            </div>
            <div>
              <h4 className="font-[FontMain] text-[#FFD300] uppercase text-xl leading-none tracking-wide md:text-[1.8vw] [text-shadow:2px_2px_0_#000000]">GODZINY OTWARCIA:</h4>
              <p className="block text-sm font-bold leading-[1.2] text-white no-underline [text-shadow:1px_1px_2px_#000000] md:text-[1.1vw]">Pon-Czw: 12:00-00:00<br />Pt-Sb: 12:00-01:00 <br />Ndz: 12:00-24:00</p>
            </div>
          </div>
        </div>
