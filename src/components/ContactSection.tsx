...
export default function ContactSection() {
  return (
    <section className="relative flex min-h-screen w-full items-center justify-between overflow-hidden border-t-6 border-black bg-[#000000] px-[5vw] py-[5vh] text-white">
      ...
      <div className="relative z-[2] flex w-full flex-col justify-start pt-[18vh] md:w-[55vw] md:pt-[8vh]">
        {/* Tytuł KONTAKT */}
        <h2
        ...
        <div className="mb-[4vh] mt-[4vh] grid grid-cols-1 gap-[2.5vh] sm:grid-cols-2 sm:gap-[2.5vh_2vw]">
          ...
          <div className="flex items-center gap-[1vw]">
            ...
            <div>
              ...
              <a href="mailto:biuro@cuzikebab.pl" className="block text-lg font-bold leading-[1.2] text-white no-underline [text-shadow:1px_1px_2px_#000000] md:text-[1.1vw]">Kontakt@cuzikebab.pl</a>
            </div>
          </div>
          ...
          <div className="flex items-center gap-[1vw]">
            ...
            <div>
              ...
              <p className="block text-lg font-bold leading-[1.2] text-white no-underline [text-shadow:1px_1px_2px_#000000] md:text-[1.1vw]">Pon-Sob: 11:00-22:00<br />Nd: Nieczynne</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-[1vw] sm:col-span-2">
            ...
            <div>
              ...
              <div className="mt-[0.5vh] flex gap-[1vw]">
                ...
                <span className="flex items-center gap-[0.5vw] border-2 border-[#FFD300] bg-black px-[0.8vw] py-[0.4vh] text-[14px] font-bold text-white md:text-[1vw]">📘 @cuzikebab</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 inline-block transition-transform duration-200 hover:scale-105" style={{ filter: "drop-shadow(6px 8px 0px #000000)" }}>
